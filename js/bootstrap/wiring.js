...
function installDevTestConsole(){
  ...
  const commands=[['SPAWN TARGETS',addTargets],['QUEUE IMPACTS 4',queueImpacts],['FORCE AIR ATTACK',forceAir],['DROP DEPTH CHARGE',depthCharge],['SET HARBOR ALERT',alert],['DECK MAN',()=>deck(true)],['DECK CLEAR',()=>deck(false)],['FILL TUBES',tubes],['FORCE SEABED',()=>seabed('seabed')],['FORCE KEEL MARGIN',()=>seabed('keel')]];
