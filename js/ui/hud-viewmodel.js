...
(function(){
  ...
  function buildHudViewModel(state,layout){
    ...
    const radio={inboxCount:Array.isArray(radioState.inbox)?radioState.inbox.length:0,pending:!!radioState.pending,copying:Number(radioState.copying||0),copyRequired:Number(radioState.copyRequired||40),keyState:radioState.enigma?.keyState||'KEY SET',workload:fixed(radioState.enigma?.workload||0,1)};
