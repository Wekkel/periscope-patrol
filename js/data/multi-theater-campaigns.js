...
/* A patrol chart is a compact tactical projection of one named, real-world
   location.  `id` stays stable for saves; `displayName` is the human-facing
   chart title.  Do not use generic coast/island placeholders here: their
   relation is part of the player’s navigation mental model. */
...
/* The object key is the stable terrain/save identity.  Descriptions are
   player-facing prose and must never become terrain cache keys. */
