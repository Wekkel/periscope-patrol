...
const VESSEL_PROFILES=Object.freeze({
  ...
  'jp-destroyer':Object.freeze({id:'jp-destroyer',factionId:'japan',gameplayType:'DESTROYER',modelKey:'DESTROYER',aswTraining:.84}),
  'jp-legacy-escort':Object.freeze({id:'jp-legacy-escort',factionId:'japan',gameplayType:'ESCORT',aswTraining:.80}),
  'jp-legacy-warship':Object.freeze({id:'jp-legacy-warship',factionId:'japan',gameplayType:'WARSHIP',aswTraining:.82}),
  'jp-kaibokan':Object.freeze({id:'jp-kaibokan',factionId:'japan',gameplayType:'KAIBOKAN',modelKey:'KAIBOKAN',aswTraining:.88}),
  'jp-patrol-craft':Object.freeze({id:'jp-patrol-craft',factionId:'japan',gameplayType:'PATROL_CRAFT',modelKey:'PATROL_CRAFT',aswTraining:.72}),
  ...
  'uk-merchant-1941':Object.freeze({id:'uk-merchant-1941',factionId:'britain',gameplayType:'MERCHANT',modelKey:'ATLANTIC_FREIGHTER',availableFrom:19390903,speedKnots:Object.freeze([7,11]),dimensionsFt:Object.freeze({length:410,beam:56}),rarity:'COMMON',recognition:'Raised forecastle, aft island, two cargo holds',doctrine:'Convoy station keeping; emergency turn and smoke when attacked'}),
  'uk-tramp-1941':Object.freeze({id:'uk-tramp-1941',factionId:'britain',gameplayType:'MERCHANT',modelKey:'ATLANTIC_TRAMP',availableFrom:19390903,speedKnots:Object.freeze([6,9]),dimensionsFt:Object.freeze({length:350,beam:50}),rarity:'COMMON',recognition:'Small aft bridge, single funnel, low cargo well',doctrine:'Slow convoy column; vulnerable to station lag and straggling'}),
  'uk-cargo-liner-1941':Object.freeze({id:'uk-cargo-liner-1941',factionId:'britain',gameplayType:'MERCHANT',modelKey:'ATLANTIC_CARGO_LINER',availableFrom:19390903,speedKnots:Object.freeze([10,16]),dimensionsFt:Object.freeze({length:455,beam:61}),rarity:'UNCOMMON',recognition:'Longer hull, central island and paired funnels',doctrine:'Fast convoy or independent routing; evasive turn under attack'}),
  'uk-coaster-1941':Object.freeze({id:'uk-coaster-1941',factionId:'britain',gameplayType:'MERCHANT',modelKey:'ATLANTIC_COASTER',availableFrom:19390903,speedKnots:Object.freeze([6,9]),dimensionsFt:Object.freeze({length:260,beam:41}),rarity:'COMMON',recognition:'Short hull, single hold and low aft house',doctrine:'Coastal or slow-convoy traffic; limited sea speed'}),
  'uk-tanker-1941':Object.freeze({id:'uk-tanker-1941',factionId:'britain',gameplayType:'TANKER',modelKey:'ATLANTIC_TANKER',availableFrom:19390903,speedKnots:Object.freeze([7,12]),dimensionsFt:Object.freeze({length:485,beam:63}),rarity:'UNCOMMON',recognition:'Aft machinery island and exposed midships pipe deck',doctrine:'Protected convoy high-value column; smoke and evasive turn when attacked'}),
  'uk-flower-corvette-1941':Object.freeze({id:'uk-flower-corvette-1941',factionId:'britain',gameplayType:'ESCORT',modelKey:'FLOWER_CORVETTE_1941',availableFrom:19400401,speedKnots:Object.freeze([12,16]),dimensionsFt:Object.freeze({length:205,beam:33}),rarity:'COMMON',armament:'1×4-in, light AA, depth charges',sensors:Object.freeze(['ASDIC']),recognition:'Short whaler hull, raised forecastle, single funnel and mast',doctrine:'Close convoy screen; ASDIC datum attack and depth-charge pattern',aswTraining:.88}),
  'ca-flower-corvette-1941':Object.freeze({id:'ca-flower-corvette-1941',factionId:'canada',gameplayType:'ESCORT',modelKey:'FLOWER_CORVETTE_1941',availableFrom:19401101,speedKnots:Object.freeze([12,16]),dimensionsFt:Object.freeze({length:205,beam:33}),rarity:'COMMON',armament:'1×4-in, light AA, depth charges',sensors:Object.freeze(['ASDIC']),recognition:'RCN Flower-class; compact whaler hull and single funnel',doctrine:'Close convoy screen; ASDIC datum attack and depth-charge pattern',aswTraining:.85}),
  'uk-town-destroyer-1941':Object.freeze({id:'uk-town-destroyer-1941',factionId:'britain',gameplayType:'DESTROYER',modelKey:'TOWN_DESTROYER_1941',availableFrom:19400909,speedKnots:Object.freeze([20,35]),dimensionsFt:Object.freeze({length:314,beam:31}),rarity:'UNCOMMON',armament:'4×4-in, torpedoes, depth charges',sensors:Object.freeze(['ASDIC']),recognition:'Flush deck, four funnels and narrow Great War destroyer hull',doctrine:'Outer screen, contact reinforcement and high-speed depth-charge prosecution',aswTraining:.90}),
  'uk-black-swan-sloop':Object.freeze({id:'uk-black-swan-sloop',factionId:'britain',gameplayType:'ESCORT',modelKey:'BLACK_SWAN_SLOOP',availableFrom:19390701,speedKnots:Object.freeze([15,20]),dimensionsFt:Object.freeze({length:299,beam:38.5}),rarity:'RARE',armament:'6×4-in dual-purpose, AA, depth charges',sensors:Object.freeze(['ASDIC']),recognition:'Long high forecastle, twin funnels and three enclosed twin mounts',doctrine:'Ocean escort and reinforcement; sustained ASDIC prosecution',aswTraining:1.08}),
  'uk-river-frigate-1942':Object.freeze({id:'uk-river-frigate-1942',factionId:'britain',gameplayType:'ESCORT',modelKey:'RIVER_FRIGATE_1942',availableFrom:19420401,speedKnots:Object.freeze([15,20]),dimensionsFt:Object.freeze({length:301,beam:36.5}),rarity:'UNCOMMON',armament:'2×4-in, AA, depth charges',sensors:Object.freeze(['ASDIC','TYPE_271_RADAR']),recognition:'Long forecastle, two widely spaced guns and compact funnel',doctrine:'Long-range ocean escort; radar cueing into coordinated ASDIC search',aswTraining:1.04}),
  'uk-armed-trawler':Object.freeze({id:'uk-armed-trawler',factionId:'britain',gameplayType:'PATROL_CRAFT',modelKey:'ARMED_TRAWLER',availableFrom:19390903,speedKnots:Object.freeze([8,12]),dimensionsFt:Object.freeze({length:150,beam:27}),rarity:'UNCOMMON',armament:'1×4-in or 12-pdr, depth charges',sensors:Object.freeze(['ASDIC_OPTIONAL']),recognition:'Deep fishing hull, high bow and small aft working deck',doctrine:'Local patrol and convoy support; visual search and short depth-charge runs',aswTraining:.74})
});
...
const AIRCRAFT_PROFILES=Object.freeze({
  'raf-sunderland':Object.freeze({id:'raf-sunderland',factionId:'britain',name:'Short Sunderland',kind:'FLYING_BOAT',availableFrom:19390601,engines:4,spanM:34.4,lengthM:26.0,speedKnots:Object.freeze([145,183]),ordnance:'DEPTH_CHARGE',recognition:'High parasol wing, boat hull and four engines',doctrine:'Long-range daylight ocean search, shadowing and repeated low-level depth-charge runs',audio:Object.freeze({key:'FLYING_BOAT',engines:4,rpm:2100,blades:3,weight:1.18,dark:.86})}),
  'raf-hudson':Object.freeze({id:'raf-hudson',factionId:'britain',name:'Lockheed Hudson',kind:'BOMBER',availableFrom:19391201,engines:2,spanM:19.96,lengthM:13.51,speedKnots:Object.freeze([175,215]),ordnance:'DEPTH_CHARGE',recognition:'Twin-engine low wing with glazed nose and twin tail',doctrine:'Coastal Command sector patrol with visual or radar contact followed by a shallow attack run',audio:Object.freeze({key:'TWIN_BOMBER',engines:2,rpm:2200,blades:3,weight:1.05,dark:.90})}),
  'raf-catalina':Object.freeze({id:'raf-catalina',factionId:'britain',name:'Consolidated Catalina',kind:'FLYING_BOAT',availableFrom:19410301,engines:2,spanM:31.7,lengthM:19.5,speedKnots:Object.freeze([105,170]),ordnance:'DEPTH_CHARGE',recognition:'High wing, boat hull and retracting wingtip floats',doctrine:'Very-long-endurance search, convoy coverage and contact reporting before attack',audio:Object.freeze({key:'PBY',engines:2,rpm:2050,blades:3,weight:1.10,dark:.88})}),
  'raf-wellington-leigh':Object.freeze({id:'raf-wellington-leigh',factionId:'britain',name:'Vickers Wellington',kind:'BOMBER',availableFrom:19420601,engines:2,spanM:26.3,lengthM:19.7,speedKnots:Object.freeze([180,220]),ordnance:'DEPTH_CHARGE',recognition:'Twin-engine mid-wing bomber; radar/Leigh Light fit',doctrine:'Night radar search with Leigh Light illumination immediately before the depth-charge run',audio:Object.freeze({key:'TWIN_BOMBER',engines:2,rpm:2200,blades:3,weight:1.05,dark:.90})}),
  'raf-vlr-liberator':Object.freeze({id:'raf-vlr-liberator',factionId:'britain',name:'Very Long Range Liberator',kind:'BOMBER',availableFrom:19430301,engines:4,spanM:33.5,lengthM:20.6,speedKnots:Object.freeze([190,250]),ordnance:'DEPTH_CHARGE',recognition:'Four engines, Davis wing and twin oval tail fins',doctrine:'Mid-ocean gap patrol using radar-assisted wide-area search and sustained contact prosecution',audio:Object.freeze({key:'FOUR_ENGINE_BOMBER',engines:4,rpm:2150,blades:3,weight:1.20,dark:.85})}),
  'luftwaffe-fw200':Object.freeze({id:'luftwaffe-fw200',factionId:'germany',name:'Focke-Wulf Fw 200',kind:'BOMBER',availableFrom:19400601,engines:4,spanM:32.9,lengthM:23.5,speedKnots:Object.freeze([180,225]),ordnance:'BOMB',recognition:'Long four-engine airliner-derived maritime patrol aircraft',doctrine:'Long-range convoy reconnaissance, shadow reports and level or low-altitude bombing',audio:Object.freeze({key:'FOUR_ENGINE_BOMBER',engines:4,rpm:2150,blades:3,weight:1.20,dark:.85})}),
  'luftwaffe-ju88':Object.freeze({id:'luftwaffe-ju88',factionId:'germany',name:'Junkers Ju 88',kind:'BOMBER',availableFrom:19390901,engines:2,spanM:20.0,lengthM:14.4,speedKnots:Object.freeze([220,270]),ordnance:'BOMB',recognition:'Twin-engine bomber with glazed nose and single fin',doctrine:'Fast maritime strike and armed reconnaissance with diving or low-level attack',audio:Object.freeze({key:'TWIN_BOMBER',engines:2,rpm:2280,blades:3,weight:.95,dark:.93})})
});
...
const GERMAN_ATLANTIC_1941_PRIMARY_CONVOY_PROFILE=Object.freeze({
  ...
  merchantTemplates:Object.freeze([
    ...
    Object.freeze({id:'AM-03',name:'Tramp Steamer',type:'MERCHANT',vesselProfileId:'uk-tramp-1941',modelKey:'ATLANTIC_TRAMP',side:'ENEMY',displayType:'TRAMP STEAMER',lengthYards:350,visualProfile:.86,acousticBase:.30,tonsFactor:3300}),
    Object.freeze({id:'AM-04',name:'Cargo Liner',type:'MERCHANT',vesselProfileId:'uk-cargo-liner-1941',modelKey:'ATLANTIC_CARGO_LINER',side:'ENEMY',displayType:'CARGO LINER',lengthYards:455,visualProfile:1.00,acousticBase:.37,tonsFactor:5900}),
    ...
    Object.freeze({id:'AM-07',name:'Coaster in Convoy',type:'MERCHANT',vesselProfileId:'uk-coaster-1941',modelKey:'ATLANTIC_COASTER',side:'ENEMY',displayType:'COASTAL FREIGHTER',lengthYards:260,visualProfile:.80,acousticBase:.27,tonsFactor:2700}),
    Object.freeze({id:'AM-08',name:'Cargo Steamer',type:'MERCHANT',vesselProfileId:'uk-tramp-1941',modelKey:'ATLANTIC_TRAMP',side:'ENEMY',displayType:'TRAMP STEAMER',lengthYards:405,visualProfile:.93,acousticBase:.34,tonsFactor:4600}),
  ...
  escortTemplates:Object.freeze([
    ...
    Object.freeze({id:'AE-03',name:'Town-class Destroyer',type:'DESTROYER',vesselProfileId:'uk-town-destroyer-1941',modelKey:'TOWN_DESTROYER_1941',side:'ENEMY',displayType:'TOWN-CLASS DESTROYER',lengthYards:314,visualProfile:.72,acousticBase:.68,tonsFactor:1200,hasSonar:true}),
  ...
  content:Object.freeze({
    ...
    shadowReport:Object.freeze({
      ...
      objectiveTexts:Object.freeze({
        ...
        release:'Copy B.d.U. attack order',approach:'After dark: surface, move 0.8–3.5 nm ahead near the plotted convoy track, avoid firm contact, and hold 30 sec',
