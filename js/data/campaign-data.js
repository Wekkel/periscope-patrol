...
const PATROL_AREAS={
  ...
  'Sulu Sea / Tawi-Tawi':{
    ...
    ports:[{name:'Tawi-Tawi anchorage',pos:{xNm:-28,yNm:69},side:'ENEMY'},{name:'Sandakan approaches',pos:{xNm:-142,yNm:22},side:'ENEMY'},{name:'Submarine rendezvous',pos:{xNm:78,yNm:-96},side:'FRIENDLY'}],
