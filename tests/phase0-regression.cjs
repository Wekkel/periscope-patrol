...
const load=[
  ...
  'js/simulation/sensors.js','js/simulation/ai/escort-asw.js','js/simulation/collision/vessel-collision.js','js/simulation/physics-navigation.js','js/core/game.js',
